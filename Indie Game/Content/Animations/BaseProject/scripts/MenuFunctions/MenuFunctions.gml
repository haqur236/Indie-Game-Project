// desc menu - makes a menu, options proved in the form of [["name", function, argument], [...]]
function menu (_x, _y, _options, _description = -1, _width = undefined, _height = undefined)
{
	with (instance_create_depth(__x,__y, -99999, oMenu))
	{
		options = _options;
...
function MenuSelectAction(_user, _action)
{
	...
	//Activate targting cursor if needed, or simply begin the action
	with (oMenu) 
	{
